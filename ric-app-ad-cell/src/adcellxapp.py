...
class ADCellXapp:
    ...
    def _post_init(self, rmr_xapp):
        ...
        """
        rmr_xapp.logger.info("ADCellXapp.post_init :: post_init called")
    ...
    def _handle_config_change(self, rmr_xapp, config):
        ...
        """
        rmr_xapp.logger.info("ADCellXapp.handle_config_change:: config: {}".format(config))
    ...
    def _default_handler(self, rmr_xapp, summary, sbuf):
        ...
        """
        rmr_xapp.logger.info("ADCellXapp.default_handler called for msg type = " +
